...
BOOKS_SQL= """
                ...
                AUTHOR VARCHAR, 
                GENRE VARCHAR,
                YEAR VARCHAR, RATING INTEGER)
            """

AUTHOR_SQL= """
            CREATE TABLE AUTHORS
            (ID INTEGER PRIMARY KEY, 
            NAME VARCHAR, BIRTHDATE TEXT)
            """
...
INSERT_AUTHOR_SQL= """INSERT INTO AUTHORS(NAME, BIRTHDATE) VALUES (?, ?)"""

INSERT_GENRE_SQL= """INSERT INTO GENRES(NAME) VALUES (?)"""

INSERT_BOOK_SQL= """INSERT INTO BOOKS(TITLE, YEAR, AUTHOR, GENRE, RATING) VALUES (?, ?, ?, ?, ?)"""
